...
async function saveData(req,res){
    ...
    const { recipient, subject, message, date } = req.body;
    ...
    if (sentEmail) {
        data.sent.push({ id, recipient, subject, message, date, sentEmail });
    } else {
        data.unsent.push({ id, recipient, subject, message, date, sentEmail });
    }
